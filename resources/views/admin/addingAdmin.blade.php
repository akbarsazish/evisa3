               ...
               <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" class="form-control form-control-sm" placeholder="علی احمدی">
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="mb-3">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="mb-3">
                            ...
                            <input type="password" name="password" class="form-control form-control-sm" placeholder="abc@123">
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="mb-3">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="mb-3">
                            ...
                            <input type="number" name="cellPhone" class="form-control form-control-sm" placeholder="0093706909063">
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="mb-3">
                            <label for="pwd"> 2 شماره تماس :</label>
                            <input type="number" name="otherPhone" class="form-control form-control-sm" placeholder="0093706909063">
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <select class="form-select form-select-sm" name="adminType" aria-label=".form-select-sm example">
