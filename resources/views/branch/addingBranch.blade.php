                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="mb-3">
                            ...
                            <input type="text" name="username" class="form-control form-control-sm" placeholder="aliAhmadi"  minlength="3" required>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="mb-3">
                ...
                <div class="row">
                   <div class="col-lg-4">
                        <div class="mb-3">
                            ...
                            <input type="text" name="BossName" class="form-control form-control-sm" placeholder="علی زمانی" maxlength="64"   minlength="3">
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="mb-3">
                            <label for="pwd" class="required">  آدرس :</label>
                            <input type="text" name="Address" class="form-control form-control-sm" placeholder="کابل دشت برچی" maxlength="72"   minlength="3">
                        </div>
                    </div>
                  ...
                  <div class="col-lg-4">
                        <div class="mb-3">
                            ...
                            <input type="number" name="code" class="form-control form-control-sm" placeholder="001"   minlength="2">
                        </div>
                    </div>
