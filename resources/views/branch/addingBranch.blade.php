                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-12">
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" class="form-control form-control-sm"  maxlength="64"   minlength="3" required>
                         </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-12">
                        <div class="mb-3 ">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-12">
                        <div class="mb-3">
                            ...
                            <input type="number" name="otherPhone" class="form-control form-control-sm"  maxlength="10"   minlength="10" required>
                         </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12">
                        <div class="mb-3">
                            ...
                            <input type="text" onkeyup="checkUserNameExistance(this)" name="username" class="form-control form-control-sm" minlength="3" required>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12">
                        <div class="mb-3">
                            ...
                            <input type="password" name="password" class="form-control form-control-sm" maxlength="12"   minlength="3" required>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                   <div class="col-lg-4 col-md-4 col-sm-12">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12">
                        <div class="mb-3">
                            ...
                            <input type="text" name="Address" class="form-control form-control-sm" maxlength="72"   minlength="3" required>
                        </div>
                    </div>
                  ...
                  <div class="col-lg-4 col-md-4 col-sm-12">
                        <div class="mb-3">
                            ...
                            <input type="number" name="code" class="form-control form-control-sm" minlength="2" required>
                        </div>
                    </div>
